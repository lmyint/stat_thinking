...
> For each virus (H5N1 and H7N9), we fitted models independently for each case outcome (infection or death).
...
- Did the authors perform sensitivty analyses for key assumptions?
