...
plot(1, type = "n", xlim = c(0, xend+1), ylim = range(yints, yends), xlab = "Exposure of interest", ylab = "Odds", main = "Baseline odds of disease in unexposed", xaxt = "n")
axis(side = 1, at = c(1,xend), labels = c("Unexposed", "Exposed"))
...
```{r}
plot(1, type = "n", xlim = c(0, xend+1), ylim = range(yints, yends), xlab = "Exposure of interest", ylab = "Odds", main = "Odds of disease in exposed and unexposed", xaxt = "n")
axis(side = 1, at = c(1,xend), labels = c("Unexposed", "Exposed"))
points(x = rep(xstart,n), y = yints)
...
```{r}
plot(1, type = "n", xlim = c(0, xend+1), ylim = range(yints, yends), xlab = "Exposure of interest", ylab = "Odds", main = "Odds of disease in exposed and unexposed\nPairing evident", xaxt = "n")
axis(side = 1, at = c(1,xend), labels = c("Unexposed", "Exposed"))
